...
public class EulerBanner implements Banner {
	...
	public void printBanner(Environment environment, Class<?> sourceClass, PrintStream out) {
		...
		try (BufferedReader reader = new BufferedReader(
				new InputStreamReader(EulerBanner.class.getResourceAsStream("/euler.txt"), "utf-8"))) {
		...
		out.println(AnsiOutput.toString(AnsiColor.BLUE, EULER, AnsiColor.DEFAULT, padding.toString(), AnsiStyle.BOLD,
				version));
		out.println();
	}
