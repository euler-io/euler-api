...
public class AdminOpendistroJobDetailsPersistence extends OpendistroJobDetailsPersistence
	...
	@Autowired
	public AdminOpendistroJobDetailsPersistence(OpenDistroConfiguration openDistroConfiguration,
	...
	protected void initializeJobIndex() throws IOException {
		...
		if (autoInitialize) {
			...
			initializeIndex(client, getJobIndex(), jsonMapping, RequestOptions.DEFAULT);
		}
	}
